...
|pypi| |Actions Status| |Coverage Status| |Binder| |DOI| |Developed by DLR-TS|

.. |pypi| image:: https://img.shields.io/pypi/v/tasi.svg
   :target: https://pypi.python.org/pypi/tasi/
.. |Actions Status| image:: https://github.com/dlr-ts/tasi/workflows/Tests/badge.svg
   :target: https://github.com/dlr-ts/tasi/actions?query=workflow%3ATests
.. |Coverage Status| image:: https://codecov.io/gh/dlr-ts/tasi/branch/main/graph/badge.svg
   :target: https://codecov.io/gh/dlr-ts/tasi
.. |Join the chat at https://gitter.im/dlr-ts/tasi| image:: https://badges.gitter.im/Join%20Chat.svg
   :target: https://gitter.im/dlr-ts/tasi?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
.. |Binder| image:: https://mybinder.org/badge.svg
   :target: https://mybinder.org/v2/gh/dlr-ts/tasi/main
